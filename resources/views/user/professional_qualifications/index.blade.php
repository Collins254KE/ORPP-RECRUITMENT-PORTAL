...
<div class="container">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link {{ request()->routeIs('professional_memberships.index') ? 'active' : '' }}" href="{{ route('professional_memberships.index') }}">Professional Membership</a>
        </li>
        <li class="nav-item" role="presentation">
            ...
            @else
                <table class="table" style="border: 2px solid #007bff; margin-bottom: 20px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="border-left: 1px solid #007bff;">{{ $qualification->levelDescription() }}</td>
                            <td style="border-left: 1px solid #007bff;">{{ $qualification->description }}</td>
                            ...
                            <td style="border-left: 1px solid #007bff;">
                                <a href="{{ route('professional_qualifications.edit', $qualification->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('professional_qualifications.destroy', $qualification->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
